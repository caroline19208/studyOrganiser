...
$stmt = $conn->prepare("DROP TABLE IF EXISTS STUDENT, SUBJECT, STUDENT_DOES_SUBJECT, REWARDS, STUDENT_HAS_REWARD, PAST_PAPER, STUDENT_DOES_PAST_PAPER, TOPIC, LEARNING_OBJECTIVE, ASSIGNMENT, LINKS");
$stmt->execute();
$stmt->closeCursor();
